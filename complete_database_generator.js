...
// Converts Claude_project1 database to TypeScript KoreanName format with full hanja analysis

const fs = require('fs');

// Complete EXPANDED_KOREAN_NAMES from claude_project1
const EXPANDED_KOREAN_NAMES = {
  wood: {
    male: [
...
// Complete HANJA_DATABASE
const HANJA_DATABASE = {
  wood: {
    '민': { hanja: '敏', meaning: 'quick, clever, sharp', yinYang: 'yang', strokes: 11, fortune: 'intelligence and agility' },
    '건': { hanja: '健', meaning: 'strong, robust, healthy', yinYang: 'yang', strokes: 10, fortune: 'strength and vitality' },
    '지': { hanja: '智', meaning: 'wisdom, intelligence', yinYang: 'yang', strokes: 12, fortune: 'wisdom and insight' },
    '재': { hanja: '材', meaning: 'talent, material, timber', yinYang: 'yang', strokes: 7, fortune: 'natural talent' },
    '현': { hanja: '賢', meaning: 'virtuous, wise, talented', yinYang: 'yang', strokes: 16, fortune: 'virtue and wisdom' },
    '성': { hanja: '成', meaning: 'achieve, complete, become', yinYang: 'yang', strokes: 6, fortune: 'achievement and success' },
    '준': { hanja: '俊', meaning: 'talented, handsome, outstanding', yinYang: 'yang', strokes: 9, fortune: 'outstanding talent' },
    '영': { hanja: '英', meaning: 'flower, hero, outstanding', yinYang: 'yang', strokes: 8, fortune: 'heroic excellence' },
    '우': { hanja: '宇', meaning: 'universe, house, eaves', yinYang: 'yang', strokes: 6, fortune: 'broad perspective' },
    '연': { hanja: '蓮', meaning: 'lotus flower', yinYang: 'yin', strokes: 13, fortune: 'purity and beauty' },
    '서': { hanja: '瑞', meaning: 'auspicious, lucky', yinYang: 'yin', strokes: 13, fortune: 'good fortune' },
    '원': { hanja: '原', meaning: 'source, origin, plain', yinYang: 'yang', strokes: 10, fortune: 'foundational strength' },
    '진': { hanja: '眞', meaning: 'true, real, genuine', yinYang: 'yang', strokes: 10, fortune: 'authenticity' },
    '희': { hanja: '希', meaning: 'hope, rare, wish', yinYang: 'yin', strokes: 7, fortune: 'hope and rarity' },
    '린': { hanja: '琳', meaning: 'beautiful jade', yinYang: 'yin', strokes: 12, fortune: 'precious beauty' },
    '은': { hanja: '恩', meaning: 'grace, kindness, favor', yinYang: 'yin', strokes: 10, fortune: 'divine grace' },
    '채': { hanja: '彩', meaning: 'color, talent', yinYang: 'yin', strokes: 11, fortune: 'artistic talent' },
    '예': { hanja: '藝', meaning: 'art, skill', yinYang: 'yin', strokes: 18, fortune: 'artistic mastery' },
    '하': { hanja: '荷', meaning: 'lotus, burden', yinYang: 'yin', strokes: 10, fortune: 'noble bearing' },
    '유': { hanja: '柔', meaning: 'gentle, soft', yinYang: 'yin', strokes: 9, fortune: 'gentle strength' },
    '태': { hanja: '苔', meaning: 'moss, carpet', yinYang: 'yin', strokes: 8, fortune: 'humble growth' },
    '형': { hanja: '衡', meaning: 'measure, balance', yinYang: 'yang', strokes: 16, fortune: 'balanced judgment' },
    '남': { hanja: '南', meaning: 'south', yinYang: 'yang', strokes: 9, fortune: 'warm direction' },
    '기': { hanja: '기', meaning: 'energy, spirit', yinYang: 'yang', strokes: 6, fortune: 'vital energy' },
    '제': { hanja: '濟', meaning: 'help, aid', yinYang: 'yang', strokes: 17, fortune: 'helpful nature' },
    '다': { hanja: '茶', meaning: 'tea, leisure', yinYang: 'yin', strokes: 9, fortune: 'peaceful moments' }
  },
  fire: {
    '하': { hanja: '夏', meaning: 'summer', yinYang: 'yang', strokes: 10, fortune: 'warmth and energy' },
    '시': { hanja: '始', meaning: 'beginning, start', yinYang: 'yang', strokes: 8, fortune: 'new beginnings' },
    '도': { hanja: '道', meaning: 'way, path, principle', yinYang: 'yang', strokes: 12, fortune: 'righteous path' },
    '훈': { hanja: '勳', meaning: 'meritorious deed', yinYang: 'yang', strokes: 16, fortune: 'great achievements' },
    '태': { hanja: '太', meaning: 'great, supreme', yinYang: 'yang', strokes: 4, fortune: 'supreme greatness' },
    '수': { hanja: '秀', meaning: 'excellent, outstanding', yinYang: 'yang', strokes: 7, fortune: 'exceptional talent' },
    '정': { hanja: '正', meaning: 'correct, right, just', yinYang: 'yang', strokes: 5, fortune: 'righteousness' },
    '승': { hanja: '勝', meaning: 'victory, win, overcome', yinYang: 'yang', strokes: 12, fortune: 'victory and success' },
    '동': { hanja: '東', meaning: 'east, eastern', yinYang: 'yang', strokes: 8, fortune: 'rising like the sun' },
    '환': { hanja: '煥', meaning: 'bright, brilliant', yinYang: 'yang', strokes: 13, fortune: 'brilliant radiance' },
    '아': { hanja: '雅', meaning: 'elegant, refined', yinYang: 'yin', strokes: 12, fortune: 'refined elegance' },
    '나': { hanja: '娜', meaning: 'graceful, elegant', yinYang: 'yin', strokes: 10, fortune: 'graceful beauty' },
    '다': { hanja: '多', meaning: 'many, much, abundant', yinYang: 'yin', strokes: 6, fortune: 'abundance' },
    '소': { hanja: '昭', meaning: 'bright, clear, evident', yinYang: 'yin', strokes: 9, fortune: 'clear brightness' },
    '린': { hanja: '燐', meaning: 'phosphorus, bright', yinYang: 'yin', strokes: 16, fortune: 'inner fire' },
    '지': { hanja: '智', meaning: 'wisdom, knowledge', yinYang: 'yang', strokes: 12, fortune: 'brilliant wisdom' },
    '민': { hanja: '敏', meaning: 'quick, agile', yinYang: 'yang', strokes: 11, fortune: 'quick thinking' },
    '국': { hanja: '國', meaning: 'country, nation', yinYang: 'yang', strokes: 11, fortune: 'patriotic spirit' },
    '석': { hanja: '錫', meaning: 'tin, bestow', yinYang: 'yang', strokes: 16, fortune: 'generous giving' },
    '연': { hanja: '燃', meaning: 'burn, ignite', yinYang: 'yang', strokes: 16, fortune: 'passionate energy' },
    '한': { hanja: '韓', meaning: 'Korea, great', yinYang: 'yang', strokes: 12, fortune: 'cultural pride' },
    '겸': { hanja: '謙', meaning: 'humble, modest', yinYang: 'yin', strokes: 17, fortune: 'humble wisdom' },
    '원': { hanja: '元', meaning: 'origin, first', yinYang: 'yang', strokes: 4, fortune: 'original brilliance' },
    '진': { hanja: '辰', meaning: 'morning, time', yinYang: 'yang', strokes: 7, fortune: 'perfect timing' },
    '영': { hanja: '榮', meaning: 'glory, flourish', yinYang: 'yang', strokes: 14, fortune: 'glorious success' },
    '혜': { hanja: '惠', meaning: 'favor, benefit', yinYang: 'yin', strokes: 12, fortune: 'blessed kindness' }
  },
  earth: {
    '이': { hanja: '二', meaning: 'two, second', yinYang: 'yin', strokes: 2, fortune: 'harmony and balance' },
    '주': { hanja: '主', meaning: 'master, main, principal', yinYang: 'yang', strokes: 5, fortune: 'leadership' },
    '진': { hanja: '鎭', meaning: 'calm, suppress, town', yinYang: 'yang', strokes: 18, fortune: 'stability and calm' },
    '예': { hanja: '禮', meaning: 'courtesy, ritual, respect', yinYang: 'yin', strokes: 18, fortune: 'respect and propriety' },
    '호': { hanja: '浩', meaning: 'vast, grand, abundant', yinYang: 'yang', strokes: 10, fortune: 'vast potential' },
    '상': { hanja: '相', meaning: 'mutual, each other', yinYang: 'yang', strokes: 9, fortune: 'mutual prosperity' },
    '윤': { hanja: '潤', meaning: 'moist, rich, profit', yinYang: 'yin', strokes: 15, fortune: 'enriching influence' },
    '서': { hanja: '瑞', meaning: 'auspicious, felicitous', yinYang: 'yin', strokes: 13, fortune: 'auspicious events' },
    '유': { hanja: '裕', meaning: 'abundant, wealthy', yinYang: 'yin', strokes: 13, fortune: 'abundance and wealth' },
    '채': { hanja: '采', meaning: 'gather, pick, choose', yinYang: 'yin', strokes: 8, fortune: 'wise choices' },
    '연': { hanja: '延', meaning: 'extend, prolong', yinYang: 'yin', strokes: 7, fortune: 'lasting influence' },
    '지': { hanja: '地', meaning: 'earth, ground, land', yinYang: 'yin', strokes: 6, fortune: 'solid foundation' },
    '경': { hanja: '敬', meaning: 'respect, honor', yinYang: 'yin', strokes: 12, fortune: 'honorable character' },
    '정': { hanja: '靜', meaning: 'quiet, calm, peaceful', yinYang: 'yin', strokes: 16, fortune: 'inner peace' },
    '미': { hanja: '美', meaning: 'beautiful, pretty', yinYang: 'yin', strokes: 9, fortune: 'natural beauty' },
    '아': { hanja: '雅', meaning: 'elegant, refined', yinYang: 'yin', strokes: 12, fortune: 'elegant grace' },
    '나': { hanja: '那', meaning: 'which, what', yinYang: 'yin', strokes: 7, fortune: 'questioning wisdom' },
    '영': { hanja: '永', meaning: 'eternal, long', yinYang: 'yin', strokes: 5, fortune: 'lasting value' },
    '율': { hanja: '律', meaning: 'law, rule', yinYang: 'yin', strokes: 9, fortune: 'principled order' },
    '은': { hanja: '恩', meaning: 'grace, favor', yinYang: 'yin', strokes: 10, fortune: 'gracious kindness' },
    '현': { hanja: '賢', meaning: 'wise, virtuous', yinYang: 'yang', strokes: 16, fortune: 'virtuous wisdom' },
    '민': { hanja: '敏', meaning: 'quick, clever', yinYang: 'yang', strokes: 11, fortune: 'quick understanding' },
    '수': { hanja: '秀', meaning: 'excellent, refined', yinYang: 'yang', strokes: 7, fortune: 'refined excellence' },
    '효': { hanja: '孝', meaning: 'filial piety', yinYang: 'yin', strokes: 7, fortune: 'family devotion' },
    '규': { hanja: '奎', meaning: 'star, writing', yinYang: 'yang', strokes: 9, fortune: 'literary talent' },
    '찬': { hanja: '讚', meaning: 'praise, admire', yinYang: 'yang', strokes: 19, fortune: 'worthy of praise' }
  },
  metal: {
    '서': { hanja: '西', meaning: 'west, western', yinYang: 'yin', strokes: 6, fortune: 'decisive action' },
    '태': { hanja: '泰', meaning: 'great, peaceful', yinYang: 'yang', strokes: 9, fortune: 'great peace' },
    '현': { hanja: '炫', meaning: 'bright, dazzling', yinYang: 'yang', strokes: 9, fortune: 'brilliant achievement' },
    '승': { hanja: '承', meaning: 'inherit, receive', yinYang: 'yang', strokes: 8, fortune: 'carrying on legacy' },
    '정': { hanja: '貞', meaning: 'chaste, virtuous', yinYang: 'yin', strokes: 9, fortune: 'moral integrity' },
    '철': { hanja: '哲', meaning: 'wise, philosophy', yinYang: 'yang', strokes: 10, fortune: 'philosophical wisdom' },
    '석': { hanja: '石', meaning: 'stone, rock', yinYang: 'yang', strokes: 5, fortune: 'solid strength' },
    '호': { hanja: '鎬', meaning: 'bright, shining', yinYang: 'yang', strokes: 18, fortune: 'shining excellence' },
    '진': { hanja: '珍', meaning: 'precious, valuable', yinYang: 'yin', strokes: 9, fortune: 'precious value' },
    '영': { hanja: '瑛', meaning: 'crystal, gem', yinYang: 'yin', strokes: 12, fortune: 'gem-like purity' },
    '소': { hanja: '素', meaning: 'plain, simple, pure', yinYang: 'yin', strokes: 10, fortune: 'pure simplicity' },
    '혜': { hanja: '惠', meaning: 'favor, benefit, wise', yinYang: 'yin', strokes: 12, fortune: 'wise kindness' },
    '수': { hanja: '修', meaning: 'cultivate, study', yinYang: 'yang', strokes: 10, fortune: 'self-cultivation' },
    '은': { hanja: '銀', meaning: 'silver', yinYang: 'yin', strokes: 14, fortune: 'pure value' },
    '금': { hanja: '金', meaning: 'gold, metal', yinYang: 'yang', strokes: 8, fortune: 'precious strength' },
    '린': { hanja: '鈴', meaning: 'bell, chime', yinYang: 'yin', strokes: 13, fortune: 'harmonious sound' },
    '유': { hanja: '裕', meaning: 'abundant, rich', yinYang: 'yin', strokes: 13, fortune: 'abundant resources' },
    '아': { hanja: '雅', meaning: 'elegant, refined', yinYang: 'yin', strokes: 12, fortune: 'refined elegance' },
    '인': { hanja: '仁', meaning: 'benevolence, humanity', yinYang: 'yang', strokes: 4, fortune: 'humanistic virtue' },
    '지': { hanja: '智', meaning: 'wisdom, knowledge', yinYang: 'yang', strokes: 12, fortune: 'metallic wisdom' },
    '민': { hanja: '敏', meaning: 'quick, sharp', yinYang: 'yang', strokes: 11, fortune: 'sharp intelligence' },
    '찬': { hanja: '燦', meaning: 'brilliant, bright', yinYang: 'yang', strokes: 17, fortune: 'brilliant radiance' },
    '빈': { hanja: '彬', meaning: 'refined, elegant', yinYang: 'yang', strokes: 11, fortune: 'refined character' },
    '한': { hanja: '韓', meaning: 'great, Korea', yinYang: 'yang', strokes: 12, fortune: 'great strength' },
    '우': { hanja: '優', meaning: 'excellent, actor', yinYang: 'yin', strokes: 17, fortune: 'excellent performance' },
    '채': { hanja: '彩', meaning: 'color, variety', yinYang: 'yin', strokes: 11, fortune: 'colorful talents' },
    '령': { hanja: '鈴', meaning: 'bell, sound', yinYang: 'yin', strokes: 13, fortune: 'beautiful resonance' },
    '나': { hanja: '娜', meaning: 'graceful, elegant', yinYang: 'yin', strokes: 10, fortune: 'graceful strength' }
  },
  water: {
    '은': { hanja: '殷', meaning: 'abundant, flourishing', yinYang: 'yin', strokes: 10, fortune: 'abundant prosperity' },
    '준': { hanja: '濬', meaning: 'deep, profound', yinYang: 'yang', strokes: 17, fortune: 'deep wisdom' },
    '민': { hanja: '民', meaning: 'people, citizen', yinYang: 'yang', strokes: 5, fortune: 'serving people' },
    '호': { hanja: '湖', meaning: 'lake', yinYang: 'yin', strokes: 12, fortune: 'calm depth' },
    '현': { hanja: '泫', meaning: 'weep, glisten', yinYang: 'yin', strokes: 8, fortune: 'emotional depth' },
    '수': { hanja: '水', meaning: 'water', yinYang: 'yin', strokes: 4, fortune: 'flowing adaptability' },
    '정': { hanja: '淨', meaning: 'clean, pure, clear', yinYang: 'yin', strokes: 11, fortune: 'pure clarity' },
    '혁': { hanja: '赫', meaning: 'bright, radiant', yinYang: 'yang', strokes: 14, fortune: 'radiant success' },
    '윤': { hanja: '尹', meaning: 'govern, direct', yinYang: 'yang', strokes: 4, fortune: 'wise guidance' },
    '빈': { hanja: '彬', meaning: 'refined, elegant', yinYang: 'yang', strokes: 11, fortune: 'refined character' },
    '서': { hanja: '書', meaning: 'book, write', yinYang: 'yang', strokes: 10, fortune: 'scholarly wisdom' },
    '지': { hanja: '池', meaning: 'pond, pool', yinYang: 'yin', strokes: 6, fortune: 'nurturing environment' },
    '혜': { hanja: '慧', meaning: 'wisdom, intelligence', yinYang: 'yin', strokes: 15, fortune: 'profound wisdom' },
    '미': { hanja: '沫', meaning: 'foam, bubble', yinYang: 'yin', strokes: 8, fortune: 'gentle influence' },
    '영': { hanja: '泳', meaning: 'swim, dive', yinYang: 'yang', strokes: 8, fortune: 'fluid movement' },
    '진': { hanja: '珍', meaning: 'precious, treasure', yinYang: 'yin', strokes: 9, fortune: 'precious wisdom' },
    '주': { hanja: '注', meaning: 'pour, focus', yinYang: 'yang', strokes: 8, fortune: 'focused attention' },
    '연': { hanja: '淵', meaning: 'deep water, abyss', yinYang: 'yin', strokes: 12, fortune: 'profound depths' },
    '인': { hanja: '人', meaning: 'person, human', yinYang: 'yang', strokes: 2, fortune: 'humanity' },
    '림': { hanja: '林', meaning: 'forest, woods', yinYang: 'yin', strokes: 8, fortune: 'natural abundance' },
    '해': { hanja: '海', meaning: 'sea, ocean', yinYang: 'yin', strokes: 10, fortune: 'vast possibilities' }
  }
};

// Helper functions
function createTranslations(en, ko) {
  return {
    en,
    ko,
    ja: en, // Will be replaced with proper translations in the future
    fr: en,
    de: en,
    es: en,
    it: en,
...
function findHanjaInAllElements(char) {
  for (const element of ['wood', 'fire', 'earth', 'metal', 'water']) {
    if (HANJA_DATABASE[element][char]) {
      return HANJA_DATABASE[element][char];
    }
  }
  return null;
}

function calculatePronunciationMatch(romanization, englishSound) {
  const rom = romanization.toLowerCase().replace(/-/g, '');
  const eng = englishSound.toLowerCase().replace(/-/g, '');

  let matches = 0;
  let total = Math.max(rom.length, eng.length);

  for (let i = 0; i < Math.min(rom.length, eng.length); i++) {
    if (rom[i] === eng[i]) {
      matches++;
    } else if (
      (rom[i] === 'u' && eng[i] === 'oo') ||
...
function generateHanja(koreanName, element) {
  const characters = koreanName.split('');
  let hanja = '';

  for (const char of characters) {
    const hanjaInfo = HANJA_DATABASE[element]?.[char] || findHanjaInAllElements(char);
    if (hanjaInfo) {
      hanja += hanjaInfo.hanja;
    } else {
      // If no hanja found, try common alternatives
      const commonHanja = {
        '민': '民', '준': '俊', '서': '瑞', '지': '智', '현': '賢',
        '우': '宇', '호': '浩', '영': '榮', '수': '秀', '연': '延',
        '은': '恩', '진': '眞', '아': '雅', '나': '娜', '윤': '允'
      };
      hanja += commonHanja[char] || char;
    }
  }
...
function generateHanjaBreakdown(koreanName, element) {
  const characters = koreanName.split('');
  const breakdown = {
    characters: [],
    traditionalMeaning: {}
  ...
  for (const char of characters) {
    const hanjaInfo = HANJA_DATABASE[element]?.[char] || findHanjaInAllElements(char);
    if (hanjaInfo) {
      breakdown.characters.push({
        korean: char,
        hanja: hanjaInfo.hanja,
        meaning: createTranslations(hanjaInfo.meaning, hanjaInfo.meaning)
      });
    }
  }

  // Generate traditional meaning
  if (breakdown.characters.length >= 2) {
    const firstChar = breakdown.characters[0];
    const secondChar = breakdown.characters[1];
    const elementMeanings = {
      wood: 'supports natural growth and creative development, like a tree that reaches toward the light while staying rooted in wisdom',
      fire: 'ignites passionate leadership and brilliant achievement, like a flame that illuminates the path for others to follow',
      earth: 'builds stable foundations for lasting success, like fertile ground that nurtures seeds into abundant harvest',
      metal: 'forges strength through principled action, like precious metal that becomes more valuable through refinement',
      water: 'flows with adaptive wisdom and deep understanding, like a river that finds the most beneficial path forward'
    };

    const traditionalEn = `"${firstChar.meaning.en}" combined with "${secondChar.meaning.en}" creates harmonious meaning that ${elementMeanings[element]}`;
    const traditionalKo = `"${firstChar.meaning.ko}"와 "${secondChar.meaning.ko}"가 결합되어 ${elementMeanings[element]}하는 조화로운 의미를 만듭니다`;

    breakdown.traditionalMeaning = createTranslations(traditionalEn, traditionalKo);
  }

  return breakdown;
}

function convertNameToTypescript(nameData, element, gender) {
  const hanja = generateHanja(nameData.korean, element);
  const hanjaBreakdown = generateHanjaBreakdown(nameData.korean, element);
  const pronunciationMatch = calculatePronunciationMatch(nameData.romanization, nameData.englishSound);

  const style = nameData.kpopMember ? 'kpop' : 'modern';

  return {
    korean: nameData.korean,
    hanja,
    romanization: nameData.romanization,
    pronunciation: nameData.englishSound,
    meaning: createTranslations(nameData.meaning, nameData.meaning),
    story: createTranslations(nameData.story, nameData.story),
    element,
    gender,
    popularity: nameData.popularity,
    kpopMember: nameData.kpopMember,
    style,
    hanjaBreakdown,
    pronunciationMatch
  };
...
function generateCompleteDatabase() {
  ...
  for (const [element, genderData] of Object.entries(EXPANDED_KOREAN_NAMES)) {
    for (const [gender, names] of Object.entries(genderData)) {
      for (const nameData of names) {
        const convertedName = convertNameToTypescript(nameData, element, gender);
...
function generateTypescriptFile() {
  const names = generateCompleteDatabase();

  const header = `// Multilingual Korean Name Database
// Based on traditional Saju elements and modern popularity
// Complete migration from Claude_project1 database with full hanja analysis
...
export const KOREAN_NAMES: KoreanName[] = [`;
  ...
  const namesJson = JSON.stringify(names, null, 2)
    ...
    .replace(/'(en|ko|ja|fr|de|es|it|pt|th|id|korean|hanja|romanization|pronunciation|element|gender|style|group|memberName|kpopMember|meaning|story|hanjaBreakdown|characters|traditionalMeaning)':/g, '"$1":') // Restore quotes for specific keys
    .replace(/createTranslations\('([^']+)', '([^']+)'\)/g, 'createTranslations("$1", "$2")'); // Fix function calls
...
export const NAME_STATISTICS = {
  total: ${names.length},
  maleNames: ${names.filter(n => n.gender === 'male').length},
  femaleNames: ${names.filter(n => n.gender === 'female').length},
  byElement: {
    wood: {
      male: ${names.filter(n => n.element === 'wood' && n.gender === 'male').length},
      female: ${names.filter(n => n.element === 'wood' && n.gender === 'female').length},
      total: ${names.filter(n => n.element === 'wood').length}
    },
    fire: {
      male: ${names.filter(n => n.element === 'fire' && n.gender === 'male').length},
      female: ${names.filter(n => n.element === 'fire' && n.gender === 'female').length},
      total: ${names.filter(n => n.element === 'fire').length}
    },
    earth: {
      male: ${names.filter(n => n.element === 'earth' && n.gender === 'male').length},
      female: ${names.filter(n => n.element === 'earth' && n.gender === 'female').length},
      total: ${names.filter(n => n.element === 'earth').length}
    },
    metal: {
      male: ${names.filter(n => n.element === 'metal' && n.gender === 'male').length},
      female: ${names.filter(n => n.element === 'metal' && n.gender === 'female').length},
      total: ${names.filter(n => n.element === 'metal').length}
    },
    water: {
      male: ${names.filter(n => n.element === 'water' && n.gender === 'male').length},
      female: ${names.filter(n => n.element === 'water' && n.gender === 'female').length},
      total: ${names.filter(n => n.element === 'water').length}
    }
  },
  kpopNames: ${names.filter(n => n.kpopMember).length},
  popularityRange: {
    highest: ${Math.max(...names.map(n => n.popularity))},
    lowest: ${Math.min(...names.map(n => n.popularity))},
    average: ${Math.round(names.reduce((sum, n) => sum + n.popularity, 0) / names.length)}
  }
};`;

  return header + namesJson + footer;
}

// Execute the script
if (require.main === module) {
  try {
    console.log('Generating complete Korean name database...');
    const typescriptContent = generateTypescriptFile();

    // Write to backup first
    fs.writeFileSync('./koreanNames_new.ts', typescriptContent);
    console.log('✅ Complete database generated successfully!');
    console.log(`📊 Generated ${generateCompleteDatabase().length} names with full hanja analysis`);
    console.log('📁 File saved as: ./koreanNames_new.ts');
